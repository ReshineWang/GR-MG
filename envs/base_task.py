    ...
    def apply_GR_MG(self, model, ip2p_model, args):
        ...
        while step_cnt < self.step_lim: # If it is not successful within the specified number of steps, it is judged as a failure.
            ...
            if step_cnt  % 20 == 0:  # hardcode
                ...
                # save images
                static_rgb_image = Image.fromarray(static_rgb)
                hand_rgb_image = Image.fromarray(hand_rgb)
                goal_image_image = Image.fromarray(goal_image[0])
                static_rgb_image.save(os.path.join(image_save_dir, f"static_rgb_{step_cnt}.png"))
                hand_rgb_image.save(os.path.join(image_save_dir, f"hand_rgb_{step_cnt}.png"))
